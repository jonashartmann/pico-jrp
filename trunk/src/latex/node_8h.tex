...
\item 
int \hyperlink{node_8h_1e1a21ca62ad4d35baa0bf0694e5a241}{pack\_\-nodes} (Node $\ast$$\ast$$\ast$array\_\-of\_\-nodes, int cur\_\-size, Node $\ast$n)
\item 
...
\subsubsection[{child}]{\setlength{\rightskip}{0pt plus 5cm}Node$\ast$ child (Node $\ast$ {\em n}, \/  int {\em i})}}
...
\item[Parâmetros:]
\begin{description}
\item[{\em n}]: the node to be consulted. Must return en error if 'n' is NULL. \item[{\em i}]: the number of the child that one wants. Must be lower than n-$>$num\_\-children and larger than 0. Must return an error if i is not correct. \end{description}
\end{Desc}
\begin{Desc}
...
\subsubsection[{create\_\-leaf}]{\setlength{\rightskip}{0pt plus 5cm}Node$\ast$ create\_\-leaf (int {\em nl}, \/  Node\_\-type {\em t}, \/  char $\ast$ {\em lexema}, \/  void $\ast$ {\em att})}}
...
\subsubsection[{create\_\-node}]{\setlength{\rightskip}{0pt plus 5cm}Node$\ast$ create\_\-node (int {\em nl}, \/  Node\_\-type {\em t}, \/  char $\ast$ {\em lexema}, \/  void $\ast$ {\em att}, \/  int {\em nbc}, \/  Node $\ast$$\ast$ {\em children})}}
...
\subsubsection[{deep\_\-free\_\-node}]{\setlength{\rightskip}{0pt plus 5cm}int deep\_\-free\_\-node (Node $\ast$ {\em n})}}
...
\subsubsection[{height}]{\setlength{\rightskip}{0pt plus 5cm}int height (Node $\ast$ {\em n})}}
...
\subsubsection[{nb\_\-of\_\-children}]{\setlength{\rightskip}{0pt plus 5cm}int nb\_\-of\_\-children (Node $\ast$ {\em n})}}
\label{node_8h_a7faef607e574100e30b08bb3b00fe0d}


accessor to the number of children of a Node. Must return en error if 'n' is NULL. \hypertarget{node_8h_1e1a21ca62ad4d35baa0bf0694e5a241}{
\index{node.h@{node.h}!pack\_\-nodes@{pack\_\-nodes}}
\index{pack\_\-nodes@{pack\_\-nodes}!node.h@{node.h}}
\subsubsection[{pack\_\-nodes}]{\setlength{\rightskip}{0pt plus 5cm}int pack\_\-nodes (Node $\ast$$\ast$$\ast$ {\em array\_\-of\_\-nodes}, \/  int {\em cur\_\-size}, \/  Node $\ast$ {\em n})}}
\label{node_8h_1e1a21ca62ad4d35baa0bf0694e5a241}
