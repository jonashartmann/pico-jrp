...
struct _hash
{
   struct _list *hash_t[TABLE_SIZE];
};
...
/** \brief Mapear um char* para um numero inteiro.
 *
 * @param s, um char* (string).
 * @return o numero calculado a partir do char*.
 */
int hashpjw(char *s) ;
